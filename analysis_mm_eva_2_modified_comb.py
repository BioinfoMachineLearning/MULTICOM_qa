...
multi_eva_dir =  "/home/bdmlab/MM_Eva/casp14/Multi_eva_results_modified_comb_4/"
...
for _targets in list_of_file:
    ...
    final_results.append(
        [Title.replace(".csv",""), ms_top_1_score, ds_top_1_score, icps_1_score, recall_top_1_score, mm_align_top_1_score, final_top_1_score,comb_4_score_top_1_score,comb_4_rank_top_1_score,
         true_top_1_score, loss_ms_top_1_score,loss_ds_top_1_score,loss_icps_top_1_score,loss_recall_top_1_score,loss_mm_align_top_1_score,loss_final_top_1_score,loss_comb_4_score_top_1_score,loss_comb_4_rank_top_1_score])

# print(final_results)

name_of_output_file = output_dir + str("casp14_comb4") + ".csv"
_header_row = ['Target',"ms_top_1_score","ds_top_1_score","icps_1_score","recall_top_1_score","mm_align_top_1_score",'final_top_1_score','comb_4_score','comb_4_rank',"true_top_1_score",'ms_loss','ds_loss','icps_loss','recall_loss','mm_align_loss','final_loss','loss_comb_4_score','loss_comb_4_rank']
