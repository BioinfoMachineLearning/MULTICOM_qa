...
input_dir = "/home/bdmlab/Multimet_evatest_samples/predictions/T1038o/"
stoichiometry = "A2"
output_dir = "/home/bdmlab/multi_eva_test/T1038/"
...
for pdb in pdb_profile_dict:
    ...
    for dimer in temp_pdb_profile.dimers:
        if dimer in valid_dimer_combindations:
            ...
            dimer_file_name = predicted_structures_dimer_cmap_dir+str(pdb)+"_chain_"+dimer+".cmap"
            if not os.path.exists(dimer_file_name):
                temp_cmaps = eva_util.get_CA_cmaps(_first_chain=monomer_a,_second_chain=monomer_b)

                np.savetxt(dimer_file_name,temp_cmaps)
