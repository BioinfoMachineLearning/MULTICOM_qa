...
final_results = []
mm_align_dir = "/home/bdmlab/mm_align_output/"
multi_eva_dir = "/home/bdmlab/Multi_eva_results_modified/"
output_dir= "/home/bdmlab/"
list_of_file = file_reader("/home/bdmlab/predictions_cleaned/casp_14_oligomers.txt")
for _targets in list_of_file:
    ...
    final_results.append(
        [Title.replace(".csv",""), ms_top_1_score, ds_top_1_score, icps_1_score, recall_top_1_score, mm_align_top_1_score, final_top_1_score,new_score_top_1_score,new_rank_top_1_score,
         true_top_1_score, loss_ms_top_1_score,loss_ds_top_1_score,loss_icps_top_1_score,loss_recall_top_1_score,loss_mm_align_top_1_score,loss_final_top_1_score,loss_new_score_top_1_score,loss_new_rank_top_1_score])

# print(final_results)

name_of_output_file = output_dir + str("casp_14_mm_eva_031622") + ".csv"
_header_row = ['Target',"ms_top_1_score","ds_top_1_score","icps_1_score","recall_top_1_score","mm_align_top_1_score",'final_top_1_score','new_score_top_1_score','new_rank_top_1_score', "true_top_1_score",'ms_loss','ds_loss','icps_loss','recall_loss','mm_align_loss','final_loss','new_score_loss','new_rank_top']
